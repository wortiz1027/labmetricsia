...
-- 1. Tabla base para el almacenamiento de los manuales técnicos
CREATE TABLE IF NOT EXISTS tb_technical_manuals (
    id VARCHAR(36) NOT NULL PRIMARY KEY, -- Declarada en línea para evitar conflictos
...
-- 2. Tabla de incidentes detectados
CREATE TABLE IF NOT EXISTS tb_lab_incidents (
    id VARCHAR(36) NOT NULL PRIMARY KEY, -- Declarada en línea
...
CREATE TABLE IF NOT EXISTS tb_server_metrics (
    id BIGINT AUTO_INCREMENT PRIMARY KEY, -- 🎯 SOLUCCIÓN: PRIMARY KEY en línea junto al AUTO_INCREMENT
...
-- Índices de Rendimiento para acelerar búsquedas y auditorías en tu Ryzen 7
